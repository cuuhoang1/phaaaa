      ...
      <div className="container mx-auto pt-16 pb-6">
        <div className="flex md:justify-between justify-center text-center flex-wrap md:gap-y-0 gap-y-6 ">
          <div className="md:flex-1">
            <Title addClass="text-[30px]">Liên Hệ Với Chúng Tôi</Title>
            <div className="flex flex-col gap-y-2 mt-3">
              <a href={footer?.location} target="_blank" rel="noreferrer">
                <i className="fa fa-map-marker"></i>
                <span className="inline-block ml-2">Địa Chỉ</span>
              </a>
              <div>
          ...
          <div className="md:flex-1">
            <Title addClass="text-[38px]">PHA</Title>
          ...
          <div className="md:flex-1">
            <Title addClass="text-[30px]">Giờ Mở Cửa</Title>
            <div className="flex flex-col gap-y-2 mt-3">
              <div>
        ...
        <p className="text-center mt-10">
          © 2024 All Rights Reserved By PHA Team
        </p>
      </div>
    </div>
  );
